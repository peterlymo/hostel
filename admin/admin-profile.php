...
$aid=$_SESSION['id'];
$udate=date('Y-m-d');
$query="update userregistration set email=?,updationDate=? where id=?";
...
$udate=date('Y-m-d');
	...
	if($row_cnt>0)
	{
		$con="update userregistration set password=?,updationDate=?  where id=?";
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" value="<?php echo $row->email;?>" disabled class="form-control"><span class="help-block m-b-none">
